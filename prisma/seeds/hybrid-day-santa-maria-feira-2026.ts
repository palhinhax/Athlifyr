/**
 * Seed Hybrid Day® Santa Maria da Feira 2026
...
async function main() {
  console.log("🏋️ Seeding Hybrid Day® Santa Maria da Feira 2026...");
  ...
  const event = await prisma.event.upsert({
    where: { slug: "hybrid-day-santa-maria-feira-2026" },
    update: {
      title: "Hybrid Day® Sta Maria da Feira",
      description: `# 🏋️ Hybrid Day® Santa Maria da Feira 2026

O **Hybrid Day** chega a Santa Maria da Feira, e o **EUROPARQUE** será o palco de mais um desafio inesquecível!
...
**EUROPARQUE**
Rua Interior do Europarque, Santa Maria da Feira, 4520-153
...
Cada edição do Hybrid Day é única, e Santa Maria da Feira não será exceção. Prepara-te para sentir a adrenalina, superar os teus limites e fazer parte da comunidade que está a redefinir o conceito de competição funcional em Portugal!`,
      sportTypes: [SportType.HYROX],
      startDate: new Date("2026-04-11T08:00:00Z"),
      endDate: new Date("2026-04-11T20:30:00Z"),
      city: "Santa Maria da Feira",
      country: "Portugal",
      latitude: 40.936027,
      longitude: -8.57793,
      googleMapsUrl: "https://maps.app.goo.gl/JnhaEZou1N3SnWx57",
      externalUrl: "https://www.tickettailor.com/events/hybridday",
      imageUrl: "",
      isFeatured: true,
      registrationDeadline: new Date("2026-04-11T07:59:59Z"),
    },
    create: {
      title: "Hybrid Day® Sta Maria da Feira",
      slug: "hybrid-day-santa-maria-feira-2026",
      description: `# 🏋️ Hybrid Day® Santa Maria da Feira 2026
...
8 Exercícios + 8km de corrida em Santa Maria da Feira. Testa os teus limites numa competição que combina força, resistência e determinação.
...
Singles (Women/Men/Pro), Doubles (Women/Men/Mixed/Pro), Relay (4 atletas)`,
      city: "Santa Maria da Feira",
      metaTitle:
        "Hybrid Day® Santa Maria da Feira 2026 - Inscrições | Athlifyr",
      metaDescription:
        "Participa no Hybrid Day® Santa Maria da Feira 2026. A maior competição híbrida da Península Ibérica! 8 exercícios + 8km de corrida. Inscreve-te já!",
    },
    en: {
      title: "Hybrid Day® Sta Maria da Feira",
      description: `# 🏋️ Hybrid Day® Santa Maria da Feira 2026
...
8 Exercises + 8km of running through Santa Maria da Feira. Test your limits in a competition that combines strength, endurance and determination.
...
Singles (Women/Men/Pro), Doubles (Women/Men/Mixed/Pro), Relay (4 athletes)`,
      city: "Santa Maria da Feira",
      metaTitle:
        "Hybrid Day® Santa Maria da Feira 2026 - Registration | Athlifyr",
      metaDescription:
        "Join Hybrid Day® Santa Maria da Feira 2026. The biggest hybrid competition in the Iberian Peninsula! 8 exercises + 8km running. Register now!",
    },
    es: {
      title: "Hybrid Day® Sta Maria da Feira",
      description: `# 🏋️ Hybrid Day® Santa Maria da Feira 2026
...
8 Ejercicios + 8km de carrera por Santa Maria da Feira. Pon a prueba tus límites en una competición que combina fuerza, resistencia y determinación.
...
Singles (Mujeres/Hombres/Pro), Doubles (Mujeres/Hombres/Mixto/Pro), Relay (4 atletas)`,
      city: "Santa Maria da Feira",
      metaTitle:
        "Hybrid Day® Santa Maria da Feira 2026 - Inscripciones | Athlifyr",
      metaDescription:
        "Participa en Hybrid Day® Santa Maria da Feira 2026. ¡La mayor competición híbrida de la Península Ibérica! 8 ejercicios + 8km de carrera. ¡Inscríbete ya!",
    },
    fr: {
      title: "Hybrid Day® Sta Maria da Feira",
      description: `# 🏋️ Hybrid Day® Santa Maria da Feira 2026
...
8 Exercices + 8km de course à Santa Maria da Feira. Testez vos limites dans une compétition qui combine force, endurance et détermination.
...
Singles (Femmes/Hommes/Pro), Doubles (Femmes/Hommes/Mixte/Pro), Relais (4 athlètes)`,
      city: "Santa Maria da Feira",
      metaTitle:
        "Hybrid Day® Santa Maria da Feira 2026 - Inscription | Athlifyr",
      metaDescription:
        "Participez au Hybrid Day® Santa Maria da Feira 2026. La plus grande compétition hybride de la péninsule ibérique ! 8 exercices + 8km de course. Inscrivez-vous !",
    },
    de: {
      title: "Hybrid Day® Sta Maria da Feira",
      description: `# 🏋️ Hybrid Day® Santa Maria da Feira 2026
...
8 Übungen + 8km Laufen durch Santa Maria da Feira. Testen Sie Ihre Grenzen in einem Wettbewerb, der Kraft, Ausdauer und Entschlossenheit kombiniert.
...
Singles (Frauen/Männer/Pro), Doubles (Frauen/Männer/Mixed/Pro), Staffel (4 Athleten)`,
      city: "Santa Maria da Feira",
      metaTitle: "Hybrid Day® Santa Maria da Feira 2026 - Anmeldung | Athlifyr",
      metaDescription:
        "Nehmen Sie am Hybrid Day® Santa Maria da Feira 2026 teil. Der größte Hybrid-Wettbewerb der Iberischen Halbinsel! 8 Übungen + 8km Laufen. Jetzt anmelden!",
    },
    it: {
      title: "Hybrid Day® Sta Maria da Feira",
      description: `# 🏋️ Hybrid Day® Santa Maria da Feira 2026
...
8 Esercizi + 8km di corsa a Santa Maria da Feira. Metti alla prova i tuoi limiti in una competizione che combina forza, resistenza e determinazione.
...
Singles (Donne/Uomini/Pro), Doubles (Donne/Uomini/Misto/Pro), Staffetta (4 atleti)`,
      city: "Santa Maria da Feira",
      metaTitle:
        "Hybrid Day® Santa Maria da Feira 2026 - Iscrizione | Athlifyr",
      metaDescription:
        "Partecipa all'Hybrid Day® Santa Maria da Feira 2026. La più grande competizione ibrida della Penisola Iberica! 8 esercizi + 8km di corsa. Iscriviti ora!",
    },
  };
  ...
  await findOrCreatePricingPhase("Last Chance", {
    ...
    endDate: new Date("2026-04-11T07:59:59Z"),
    price: 65.0,
    currency: Currency.EUR,
    discountPercent: null,
  ...
  console.log(
    "✅ Hybrid Day® Santa Maria da Feira 2026 seed completed successfully!"
  );
  console.log("📅 Event date: Saturday, April 11, 2026 (08:00 - 20:30)");
  console.log("📍 Location: EUROPARQUE, Santa Maria da Feira, Portugal");
...
main()
  .catch((e) => {
    console.error("❌ Error seeding Hybrid Day® Santa Maria da Feira 2026:", e);
    process.exit(1);
  })
  .finally(async () => {
