...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('FRIEND_REQUEST', 'FRIEND_ACCEPTED', 'TRIAL_REQUEST', 'TRIAL_ACCEPTED', 'TRIAL_REJECTED', 'EVENT_DATE_CHANGE', 'EVENT_CANCELLED', 'VENUE_INVITE', 'VENUE_INVITE_ACCEPTED', 'CHAT_MESSAGE', 'ADMIN_ANNOUNCEMENT');
