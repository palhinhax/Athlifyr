...
async function main() {
  console.log("🏋️ Seeding Hybrid Day® Sevilla 2026...");
  ...
  const event = await prisma.event.upsert({
    where: { slug: "hybrid-day-sevilla-2026" },
    update: {
      title: "Hybrid Day® Sevilla",
      description: `# 🏋️ Hybrid Day® Sevilla 2026

O **Hybrid Day** chega a Sevilla, e o **Centro Deportivo Bellavista** será o palco de mais um desafio inesquecível!
...
C. Gaspar Calderas, S/N, Sevilla, España, 41014
...
Cada edição do Hybrid Day é única, e Sevilla não será exceção. Prepara-te para sentir a adrenalina, superar os teus limites e fazer parte da comunidade que está a redefinir o conceito de competição funcional na Península Ibérica!`,
      sportTypes: [SportType.HYROX],
      startDate: new Date("2026-03-21T08:00:00Z"),
      endDate: new Date("2026-03-21T20:30:00Z"),
      city: "Sevilla",
      country: "España",
      latitude: 37.323305,
      longitude: -5.972397,
      googleMapsUrl: "https://maps.app.goo.gl/Qx4QfYqEoQFmtBUbA",
      externalUrl: "https://www.tickettailor.com/events/hybridday",
      imageUrl: "",
      isFeatured: true,
      registrationDeadline: new Date("2026-03-21T07:59:59Z"),
    },
    create: {
      title: "Hybrid Day® Sevilla",
...
8 Exercícios + 8km de corrida em Sevilla. Testa os teus limites numa competição que combina força, resistência e determinação.
...
Singles (Women/Men/Pro), Doubles (Women/Men/Mixed/Pro), Relay (4 atletas)`,
      city: "Sevilla",
      metaTitle: "Hybrid Day® Sevilla 2026 - Inscrições | Athlifyr",
      metaDescription:
        "Participa no Hybrid Day® Sevilla 2026. A maior competição híbrida da Península Ibérica! 8 exercícios + 8km de corrida. Inscreve-te já!",
    },
    en: {
      title: "Hybrid Day® Sevilla",
      description: `# 🏋️ Hybrid Day® Sevilla 2026
...
8 Exercises + 8km of running through Sevilla. Test your limits in a competition that combines strength, endurance and determination.
...
Singles (Women/Men/Pro), Doubles (Women/Men/Mixed/Pro), Relay (4 athletes)`,
      city: "Sevilla",
      metaTitle: "Hybrid Day® Sevilla 2026 - Registration | Athlifyr",
      metaDescription:
        "Join Hybrid Day® Sevilla 2026. The biggest hybrid competition in the Iberian Peninsula! 8 exercises + 8km running. Register now!",
    },
    es: {
      title: "Hybrid Day® Sevilla",
      description: `# 🏋️ Hybrid Day® Sevilla 2026
...
8 Ejercicios + 8km de carrera por Sevilla. Pon a prueba tus límites en una competición que combina fuerza, resistencia y determinación.
...
Singles (Mujeres/Hombres/Pro), Doubles (Mujeres/Hombres/Mixto/Pro), Relay (4 atletas)`,
      city: "Sevilla",
      metaTitle: "Hybrid Day® Sevilla 2026 - Inscripciones | Athlifyr",
      metaDescription:
        "Participa en Hybrid Day® Sevilla 2026. ¡La mayor competición híbrida de la Península Ibérica! 8 ejercicios + 8km de carrera. ¡Inscríbete ya!",
    },
    fr: {
      title: "Hybrid Day® Sevilla",
      description: `# 🏋️ Hybrid Day® Sevilla 2026
...
8 Exercices + 8km de course à Séville. Testez vos limites dans une compétition qui combine force, endurance et détermination.
...
Singles (Femmes/Hommes/Pro), Doubles (Femmes/Hommes/Mixte/Pro), Relais (4 athlètes)`,
      city: "Séville",
      metaTitle: "Hybrid Day® Sevilla 2026 - Inscription | Athlifyr",
      metaDescription:
        "Participez au Hybrid Day® Sevilla 2026. La plus grande compétition hybride de la péninsule ibérique ! 8 exercices + 8km de course. Inscrivez-vous !",
    },
    de: {
      title: "Hybrid Day® Sevilla",
      description: `# 🏋️ Hybrid Day® Sevilla 2026
...
8 Übungen + 8km Laufen durch Sevilla. Testen Sie Ihre Grenzen in einem Wettbewerb, der Kraft, Ausdauer und Entschlossenheit kombiniert.
...
Singles (Frauen/Männer/Pro), Doubles (Frauen/Männer/Mixed/Pro), Staffel (4 Athleten)`,
      city: "Sevilla",
      metaTitle: "Hybrid Day® Sevilla 2026 - Anmeldung | Athlifyr",
      metaDescription:
        "Nehmen Sie am Hybrid Day® Sevilla 2026 teil. Der größte Hybrid-Wettbewerb der Iberischen Halbinsel! 8 Übungen + 8km Laufen. Jetzt anmelden!",
    },
    it: {
      title: "Hybrid Day® Sevilla",
      description: `# 🏋️ Hybrid Day® Sevilla 2026
...
8 Esercizi + 8km di corsa a Siviglia. Metti alla prova i tuoi limiti in una competizione che combina forza, resistenza e determinazione.
...
Singles (Donne/Uomini/Pro), Doubles (Donne/Uomini/Misto/Pro), Staffetta (4 atleti)`,
      city: "Siviglia",
      metaTitle: "Hybrid Day® Sevilla 2026 - Iscrizione | Athlifyr",
      metaDescription:
        "Partecipa all'Hybrid Day® Sevilla 2026. La più grande competizione ibrida della Penisola Iberica! 8 esercizi + 8km di corsa. Iscriviti ora!",
    },
  };
  ...
  await findOrCreatePricingPhase("Last Chance", {
    ...
    endDate: new Date("2026-03-21T07:59:59Z"),
    price: 65.0,
    currency: Currency.EUR,
    discountPercent: null,
  ...
  console.log("✅ Hybrid Day® Sevilla 2026 seed completed successfully!");
  console.log("📅 Event date: Saturday, March 21, 2026 (08:00 - 20:30)");
  console.log("📍 Location: Centro Deportivo Bellavista, Sevilla, España");
...
main()
  .catch((e) => {
    console.error("❌ Error seeding Hybrid Day® Sevilla 2026:", e);
    process.exit(1);
  })
  .finally(async () => {
