...
async function main() {
  console.log("🏋️ Seeding Hybrid Day® Valencia 2026...");
  ...
  const event = await prisma.event.upsert({
    where: { slug: "hybrid-day-valencia-2026" },
    update: {
      title: "Hybrid Day® Valencia",
      description: `# 🏋️ Hybrid Day® Valencia 2026

O **Hybrid Day** chega a Valencia, e a **Feria de Valencia** será o palco de mais um desafio inesquecível!
...
**Feria de Valencia**
Av. de les Fires, s/n, Pobles de l'Oest, Valencia, España, 46035
...
Cada edição do Hybrid Day é única, e Valencia não será exceção. Prepara-te para sentir a adrenalina, superar os teus limites e fazer parte da comunidade que está a redefinir o conceito de competição funcional na Península Ibérica!`,
      sportTypes: [SportType.HYROX],
      startDate: new Date("2026-05-09T08:00:00Z"),
      endDate: new Date("2026-05-10T20:30:00Z"),
      city: "Valencia",
      country: "España",
      latitude: 39.504279,
      longitude: -0.426512,
      googleMapsUrl: "https://maps.app.goo.gl/dLyhHfAXf2iLnEJw9",
      externalUrl: "https://www.tickettailor.com/events/hybridday",
      imageUrl: "",
      isFeatured: true,
      registrationDeadline: new Date("2026-05-09T07:59:59Z"),
    },
    create: {
      title: "Hybrid Day® Valencia",
      slug: "hybrid-day-valencia-2026",
      description: `# 🏋️ Hybrid Day® Valencia 2026
...
8 Exercícios + 8km de corrida em Valencia. Testa os teus limites numa competição que combina força, resistência e determinação.
...
Singles (Women/Men/Pro), Doubles (Women/Men/Mixed/Pro), Relay (4 atletas)`,
      city: "Valencia",
      metaTitle: "Hybrid Day® Valencia 2026 - Inscrições | Athlifyr",
      metaDescription:
        "Participa no Hybrid Day® Valencia 2026. A maior competição híbrida da Península Ibérica! 8 exercícios + 8km de corrida. Inscreve-te já!",
    },
    en: {
      title: "Hybrid Day® Valencia",
      description: `# 🏋️ Hybrid Day® Valencia 2026
...
8 Exercises + 8km of running through Valencia. Test your limits in a competition that combines strength, endurance and determination.
...
Singles (Women/Men/Pro), Doubles (Women/Men/Mixed/Pro), Relay (4 athletes)`,
      city: "Valencia",
      metaTitle: "Hybrid Day® Valencia 2026 - Registration | Athlifyr",
      metaDescription:
        "Join Hybrid Day® Valencia 2026. The biggest hybrid competition in the Iberian Peninsula! 8 exercises + 8km running. Register now!",
    },
    es: {
      title: "Hybrid Day® Valencia",
      description: `# 🏋️ Hybrid Day® Valencia 2026
...
8 Ejercicios + 8km de carrera por Valencia. Pon a prueba tus límites en una competición que combina fuerza, resistencia y determinación.
...
Singles (Mujeres/Hombres/Pro), Doubles (Mujeres/Hombres/Mixto/Pro), Relay (4 atletas)`,
      city: "Valencia",
      metaTitle: "Hybrid Day® Valencia 2026 - Inscripciones | Athlifyr",
      metaDescription:
        "Participa en Hybrid Day® Valencia 2026. ¡La mayor competición híbrida de la Península Ibérica! 8 ejercicios + 8km de carrera. ¡Inscríbete ya!",
    },
    fr: {
      title: "Hybrid Day® Valencia",
      description: `# 🏋️ Hybrid Day® Valencia 2026
...
8 Exercices + 8km de course à Valence. Testez vos limites dans une compétition qui combine force, endurance et détermination.
...
Singles (Femmes/Hommes/Pro), Doubles (Femmes/Hommes/Mixte/Pro), Relais (4 athlètes)`,
      city: "Valence",
      metaTitle: "Hybrid Day® Valencia 2026 - Inscription | Athlifyr",
      metaDescription:
        "Participez au Hybrid Day® Valencia 2026. La plus grande compétition hybride de la péninsule ibérique ! 8 exercices + 8km de course. Inscrivez-vous !",
    },
    de: {
      title: "Hybrid Day® Valencia",
      description: `# 🏋️ Hybrid Day® Valencia 2026
...
8 Übungen + 8km Laufen durch Valencia. Testen Sie Ihre Grenzen in einem Wettbewerb, der Kraft, Ausdauer und Entschlossenheit kombiniert.
...
Singles (Frauen/Männer/Pro), Doubles (Frauen/Männer/Mixed/Pro), Staffel (4 Athleten)`,
      city: "Valencia",
      metaTitle: "Hybrid Day® Valencia 2026 - Anmeldung | Athlifyr",
      metaDescription:
        "Nehmen Sie am Hybrid Day® Valencia 2026 teil. Der größte Hybrid-Wettbewerb der Iberischen Halbinsel! 8 Übungen + 8km Laufen. Jetzt anmelden!",
    },
    it: {
      title: "Hybrid Day® Valencia",
      description: `# 🏋️ Hybrid Day® Valencia 2026
...
8 Esercizi + 8km di corsa a Valencia. Metti alla prova i tuoi limiti in una competizione che combina forza, resistenza e determinazione.
...
Singles (Donne/Uomini/Pro), Doubles (Donne/Uomini/Misto/Pro), Staffetta (4 atleti)`,
      city: "Valencia",
      metaTitle: "Hybrid Day® Valencia 2026 - Iscrizione | Athlifyr",
      metaDescription:
        "Partecipa all'Hybrid Day® Valencia 2026. La più grande competizione ibrida della Penisola Iberica! 8 esercizi + 8km di corsa. Iscriviti ora!",
    },
  };
  ...
  await findOrCreatePricingPhase("Last Chance", {
    ...
    endDate: new Date("2026-05-09T07:59:59Z"),
    price: 65.0,
    currency: Currency.EUR,
    discountPercent: null,
  ...
  console.log("✅ Hybrid Day® Valencia 2026 seed completed successfully!");
  console.log("📅 Event date: Saturday-Sunday, May 9-10, 2026 (08:00 - 20:30)");
  console.log("📍 Location: Feria de Valencia, Valencia, España");
...
main()
  .catch((e) => {
    console.error("❌ Error seeding Hybrid Day® Valencia 2026:", e);
    process.exit(1);
  })
  .finally(async () => {
