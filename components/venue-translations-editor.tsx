...
interface VenueTranslationsEditorProps {
  translations: Record<Language, VenueTranslation>;
  activeTab: Language;
  isLoading: boolean;
  onTranslationChange: (
    language: Language,
    field: keyof VenueTranslation,
    value: string
  ) => void;
...
export function VenueTranslationsEditor({
  translations,
  activeTab,
  isLoading,
  onTranslationChange,
  onTabChange,
}: VenueTranslationsEditorProps) {
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="grid gap-2">
                <Label htmlFor={`metaDescription-${lang.code}`}>
                  {t("metaDescriptionLabel")} ({lang.name})
                </Label>
                <Input
